...
import br.com.magnolevi.servicex.categoria.domain.CategoriaDTO;
import br.com.magnolevi.servicex.categoria.domain.CategoriaDTOResponse;
import br.com.magnolevi.servicex.categoria.services.CategoriaService;
import br.com.magnolevi.servicex.exceptios.NomeCategoriaJaExistenteException;
...
@Tag(name = "Categorias", description = "Funcionalidade das operações de Categoria")
public class CategoriaResource {

    @Autowired
    private CategoriaService categoriaService;

    @Operation(summary = "Cadasrar Categoria", description = "O recurso permite cadastrar uma categoria, porém não pode repetir o mesmo nome.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Atualizar Categoria", description = "Atualiza uma categoria pelo ID.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Sucesso"),
            @ApiResponse(responseCode = "404", description = "Não encontrado")
    })
